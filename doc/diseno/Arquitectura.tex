...
\indent \indent A continuación se especifica más detalladamente la composición de cada uno de los paquetes del modelo de diseño presentado en la sección anterior a través de sendas representaciones gráficas desglosadas \ref{subs1}, \ref{subs2} y \ref{subs3}. Para cada diagrama de componentes si es necesaria se presenta una división del mismo en un nivel más detallado. Después se describe también las clases más significativas internas al paquete dentro del \textit{Modelo de diseño}.
...
\indent \indent  La interfaz del administrador consta de varias partes, una vez logueado en el sistema dispone de un menu para el tratamiento de Usuarios, donde puede ver los que hay en uso, crear usuarios nuevos o bien eliminar alguno que no tenga trabajo pendiente. Además cuenta con un menú para la gestión de proeyctos, creación, modificado y eliminación. Finalmente puede acceder a un menú de configuración de parámetros de control de la aplicación.\\

\section{INTERFAZ DE JEFE DE PROYECTO}

\indent \indent  La interfaz del jefe de proyecto cuenta con varios menús:
\begin{enumerate}
	\item Menú de proyecto, a partir del cuál se gestiona el modelo de proceso y la división en fases del proyecto actual en el que se trabaje. Además permite la gestión de actividades del proyecto, adicción y modificación de las mismas, así cómo la supervisión y finalización de ellas. Permite este submenú realizar la gestión de trabajadores del proyecto.
	\item Menú de gestión de actividades, para la gestión de los informes de actividad creados por los usuarios.
	\item Menú de Informes, donde visualizar los informes almacenados en el sistema de proyectos anteriores y recursos del proyecto en curso.\\
\end{enumerate}

\section{INTERFAZ DE USUARIO}

\indent \indent La interfaz de usuarios es simple, permite la creación de informes de actividades en curso y la obtención de informes de actividad. Además permite la edición de los periodos vacacionales de un usuario y la visualización de los mismos.\\
